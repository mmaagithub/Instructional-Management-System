...
<html>
  <head>
    ...
    <title>My JSP 'teacherAttritube.jsp' starting page</title>
  ...
  <body>
  <% Teacher tea = (Teacher)session.getAttribute("SessionTea"); %>
 ...
 <a href="DeleteStuServlet?id=<%=tea.getTea_id()%>"> 删除</a></td>
  </body>
</html>
